...
execute unless score @s hc_x2 = @s hc_x1 run tag @s remove afk
execute unless score @s hc_y2 = @s hc_y1 run tag @s remove afk
execute unless score @s hc_z2 = @s hc_z1 run tag @s remove afk
