...
Runs on 1.13.2 vanilla minecraft server or [paper 1.13.2 version 655](https://papermc.io/api/v1/paper/1.13.2/655/download). If you use paper, please enable save-empty-scoreboard-teams and allow-non-player-entities-on-scoreboards in paper.yml BEFORE loading the world; Otherwise, the map WILL NOT work.
